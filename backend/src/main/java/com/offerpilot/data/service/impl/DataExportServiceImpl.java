...
import com.offerpilot.data.dto.QuestionExportRow;
import com.offerpilot.data.dto.UserExportRow;
    ...
    public void exportQuestions(HttpServletResponse response) {
        ...
        List<QuestionExportRow> rows = questions.stream()
                .map(q -> QuestionExportRow.builder()
                        ...
                        .jobDirection(q.getJobDirection())
                        .applicableScope(q.getApplicableScope())
                        .tags(q.getTags())
                        .standardAnswer(q.getStandardAnswer())
                        .interviewAnswer(q.getInterviewAnswer())
                        .followUpSuggestions(q.getFollowUpSuggestions())
