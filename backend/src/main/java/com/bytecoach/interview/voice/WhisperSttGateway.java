 ...
 *   bytecoach.stt.base-url: https://api.openai.com/v1
 *   bytecoach.stt.api-key: sk-...
 *   bytecoach.stt.model: whisper-1
 *   bytecoach.stt.language: zh
 *
...
public class WhisperSttGateway implements SttGateway {
    ...
    public SttResult transcribe(byte[] audioData, String mimeType) {
        if (!isAvailable()) {
            throw new IllegalStateException("STT service is not configured. Set bytecoach.stt.base-url and bytecoach.stt.api-key.");
        }
        ...
        try {
            ...
            String boundary = "----ByteCoachSttBoundary" + System.currentTimeMillis();
