...
CREATE TABLE IF NOT EXISTS chat_session (
    ...
    context_type VARCHAR(32) DEFAULT NULL COMMENT 'general / knowledge / resume / project',
    knowledge_scope VARCHAR(32) DEFAULT NULL COMMENT 'all / system / personal',
    resume_file_id BIGINT DEFAULT NULL,
    resume_project_id BIGINT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS interview_session (
    ...
    context_type VARCHAR(32) DEFAULT NULL COMMENT 'general / resume / project',
    resume_file_id BIGINT DEFAULT NULL,
    resume_project_id BIGINT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS resume_file (
    ...
    user_fix_status VARCHAR(32) NOT NULL DEFAULT 'none' COMMENT 'none / pending / updated',
...
CREATE TABLE IF NOT EXISTS job_application (
    ...
    review_suggestion VARCHAR(1000) DEFAULT NULL,
    next_step_suggestion VARCHAR(500) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS job_application_event (
    ...
    feedback_tags VARCHAR(255) DEFAULT NULL,
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
