...
const IconCards = () =>
  h('svg', { class: 'h-5 w-5', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', 'stroke-width': '2' }, [
    h('path', {
      'stroke-linecap': 'round',
      'stroke-linejoin': 'round',
      d: 'M9 6.75h10.5A1.75 1.75 0 0121.25 8.5v9A1.75 1.75 0 0119.5 19.25H9A1.75 1.75 0 017.25 17.5v-9A1.75 1.75 0 019 6.75z'
    }),
    h('path', {
      'stroke-linecap': 'round',
      'stroke-linejoin': 'round',
      d: 'M7.25 8.25H5.5A1.75 1.75 0 003.75 10v7.5c0 .966.784 1.75 1.75 1.75h10A1.75 1.75 0 0017.25 17.5v-1.25'
    })
  ])
